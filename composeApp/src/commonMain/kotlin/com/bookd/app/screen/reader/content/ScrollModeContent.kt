...
fun ScrollModeContent(
    ...
    val footnoteClickHandler: (String) -> Unit = remember(elements) {
        { footnoteId ->
    ...
    BoxWithConstraints(
        ...
        if (!constraints.isZero) {
            ...
            val engine = remember(elements, textMeasurer, settings, constraints, densityValue) {
                ReaderEngine(textMeasurer, density, Constraints.fixed(constraints.maxWidth, constraints.maxHeight), settings)
            }
            ...
            // cacheKey 独立计算
            val cacheKey = remember(bookId, chapterIndex, elements, settings, constraints, density.density) {
            ...
            Box(
                ...
                LazyColumn(
                    ...
                    itemsIndexed(safeAnchors, key = { _, anchor -> anchor }) { index, anchor ->
                        ...
                        ReaderPageCanvas(
                            ...
                            onFootnoteClick = footnoteClickHandler,
