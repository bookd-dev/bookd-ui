# client-authenticated-api-access Specification

## Purpose
Define client expectations for sending authentication headers to backend APIs whose access depends on logged-in user state.
