# client-reader-navigation-workflows Specification

## Purpose
Define client reader navigation workflows for TOC jumps, anchor-aware bookmarks, saved progress restoration, and internal EPUB links.
## Requirements
