...
- [x] 3.3 Run `cd bookd-ui && ./gradlew :shared:jvmTest` or the current equivalent test task.
- [x] 3.4 Run `cd bookd-ui && ./gradlew :shared:compileKotlinJvm` or the current equivalent compile task.
