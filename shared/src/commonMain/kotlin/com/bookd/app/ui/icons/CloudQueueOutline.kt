...
val Icons.Outlined.CloudQueue: ImageVector
    get() {
        if (_CloudQueueOutlined != null) {
            return _CloudQueueOutlined!!
        }
        _CloudQueueOutlined = ImageVector.Builder(
            name = "CloudQueueOutlined",
            defaultWidth = 24.dp,
            defaultHeight = 24.dp,
            viewportWidth = 24f,
            viewportHeight = 24f
...
private var _CloudQueueOutlined: ImageVector? = null
